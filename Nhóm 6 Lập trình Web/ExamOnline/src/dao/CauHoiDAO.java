...
public class CauHoiDAO {
	...
	public ArrayList<CauHoi> getListCHWithMaDe(String maDe, int firstResult, int maxResult) throws SQLException {
		...
		String sql = 
				"select ch.MaCH,ch.NoiDung,ch.PhuongAnA,ch.PhuongAnB,ch.PhuongAnC,ch.PhuongAnD,ch.DapAn "
				+"from examonline.ctdethi ct inner join examonline.cauhoi ch on ct.MaCH = ch.MaCH "
				+"where ct.MaDe='"+maDe+"' "
				+"order by rand() "
